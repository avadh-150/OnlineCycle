...
<head>
	...
	<link rel="stylesheet" href="assets/css/4column.css">
	...
	<div class="body-content outer-top-xs">
		...
		<h4 class="widget-title">Category</h4>
			...
			<div class='col-md-9'>
				...
				<div id="category" class="category-carousel hidden-xs" style="margin-top:-100px; width:1100px">
					<div class="item">
						<div class="image">
							<img src="assets/images/banners/main.jpg" alt="" class="img-responsive">
						</div>
						<div class="container-fluid">
							<div class="caption vertical-top text-left">
								...
								?>
									...
									<div class="excerpt hidden-sm hidden-md" style="color:#000;">
				...
				<div class="search-result-container" style="margin-top:100px;">
																	...
																	<li class="add-cart-button btn-group">
																		<?php if ($row['productAvailability'] == 'In Stock') { ?>
																			...
																			<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
																				<button class="btn" type="button" style="color:#fff; background:#000;">Add to cart</button></a>
																		<?php } else { ?>
