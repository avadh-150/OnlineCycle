...
?> 
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <!-- <img class="card-img-top" src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="350" height="300" alt="<?php echo htmlentities($row['productName']);?>" /> -->
                            <!-- <img class="card-img-top" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="<?php echo htmlentities($row['productName']);?>" width="200" height="300"></a> -->
                            <img class="card-img-top" src="admin/productimages/<?php echo $row['pid']?>/<?php echo $row['productImage1']?>" alt="<?php echo htmlentities($row['productName']);?>" width="200" height="300"></a>
