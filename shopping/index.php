...
<head>
	...
	<title>Online Bicycle Home Page</title>
			...
			<div class="furniture-container homepage-container">
				<div class="row">
					...
					<section class="my-5 py-5">
						<div class="cotainer" style="background-image: url(./assets/images/sliders/c1.jpg);">
						</div>
						<!-- ========================================= SECTION – HERO : END ========================================= -->
						<!-- ============================================== INFO BOXES ============================================== -->
										...
										<div class="products">
											...
											<div class="product">
												...
												<?php if ($row['productAvailability'] == 'In Stock') { ?>
													<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn" style="color:#fff;background:#000;">Add to Cart</a></div>
												<?php } else { ?>
